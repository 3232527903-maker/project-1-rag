<!--
source: https://www.workbuddy.cn/docs/workbuddy/Results
title: 结果查看​
-->
...
![](/docs/static/results-1.1p-6Qvw_.png)

#### 产物分享

在预览产物文件时，点击右上角分享图标：

![](/docs/static/results-2.CHN1y69w.png)

#### 上传到云端

支持上传到**我的云端网盘**、**腾讯文档**、**ima 知识库**、**乐享知识库**，在其他端的应用内也可以查看。

![](/docs/static/results-3.PA3T0X1N.png)
...
![](/docs/static/results-4.DQxfaWoG.png)
...
![](/docs/static/results-5.BQcGOAhv.png)
