<!--
source: https://www.workbuddy.cn/docs/workbuddy/From-Beginner-to-Expert-Guide/WorkBuddy-Zero-Cost-Skill-Top-10/self-improvement
...
该 Skill 的经验数据存储位置、是否支持查看/编辑/清除、是否跨设备同步等详情，请前往 [SkillHub](https://www.skillhub.cn/) 搜索了解。

**示例说明**：

如果你在某次对话中说明自己来自湖北、但不爱吃辣，后续新的对话中，`WorkBuddy` 仍可能延续这类偏好信息。

![自我改进效果示意](/docs/static/image-10.DxNkQgz0.png)
