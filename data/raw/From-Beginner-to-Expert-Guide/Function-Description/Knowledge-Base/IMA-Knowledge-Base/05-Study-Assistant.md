<!--
source: https://www.workbuddy.cn/docs/workbuddy/From-Beginner-to-Expert-Guide/Function-Description/Knowledge-Base/IMA%20Knowledge%20Base/05-Study-Assistant
title: 学业助手攻略：期末忙不过来？你的 24 小时学伴已上线​
-->

# 学业助手攻略：期末忙不过来？你的 24 小时学伴已上线

> 本章为进阶教程，如需了解操作方式，请前往 [WorkBuddy × ima 功能指引](./01-Workbuddy-IMA-Basic-Guide) 和 [如何用 WorkBuddy 把 ima 知识库越用越厚](./02-Build-Knowledge-Base)。
...
![](/docs/static/knowledge-base-ima-05-11.CdeodF_C.png)
...
![](/docs/static/knowledge-base-ima-05-12.pAw-BTCv.png)![](/docs/static/knowledge-base-ima-05-13.CCBTIptu.png)
...
>
> 1. **数据分析 Agent：** 清洗问卷数据，生成包含关键指标和图表的 Excel 文件；
> 2. **报告撰写 Agent：** 结合调研方案与分析结果，制作结构完整的调研报告；
> 3. **演示制作 Agent：** 提炼核心发现，制作一份适合 8 分钟课堂展示的 PPT。
>
> 请在各任务完成后统一汇总并交叉检查，确保 Excel、调研报告和 PPT 的数据口径、核心发现与结论保持一致。无法从现有资料中确认的信息，请明确标注，不要自行补充。

![](/docs/static/knowledge-base-ima-05-01.DWZ-8Uig.png)![](/docs/static/knowledge-base-ima-05-02.B7WhVuWM.png)
...
![](/docs/static/knowledge-base-ima-05-03.D_h8kPSl.png)![](/docs/static/knowledge-base-ima-05-04.CnjaSUIJ.png)![](/docs/static/knowledge-base-ima-05-05.CZBV8_zd.png)

### 将成果发送到微信

WorkBuddy 完成报告、PPT、表格或其他产物后，可以直接分享到微信，方便组员查看和讨论。

![](/docs/static/knowledge-base-ima-05-06.BJjEjyI5.png)![](/docs/static/knowledge-base-ima-05-07.CMyhMMhI.png)

## 四、让 AI 参与学习，而不是代替学习

![](/docs/static/knowledge-base-ima-05-08.DeStzlKV.png)
