<!--
source: https://www.workbuddy.cn/docs/workbuddy/From-Beginner-to-Expert-Guide/Function-Description/Model
title: 模型配置​
-->
...
优先深度与准确性，适合复杂分析和高要求任务。

### 内置模型

| 模型名称 | 简介 | 可用功能 |
| --- | --- | --- |
| Hy3 | 混元思考模型，具有增强的推理能力，限时免费 | √ 图片输入   √ 思考模式 |
| GLM-5.2 | 1M 上下文，擅长长程任务 | √ 图片输入   √ 思考模式 |
| GLM-5.1 | 能力均衡，适合日常使用 | √ 推理模型 |
| GLM-5v-Turbo | 原生多模态模型 | √ 图片输入   √ 推理模型 |
| MiniMax-M3 | 原生多模态，擅长代码、智能体任务 | √ 图片输入   √ 推理模型 |
| MiniMax-m2.7 | 能力均衡，适合日常使用，性价比高 | √ 图片输入   √ 推理模型 |
| Kimi-K3 | 擅长处理复杂的长程自主任务，前端开发能力突出，同时在知识工作与科研推理上表现出色 | √ 图片输入   √ 推理模型 |
| Kimi-K2.7-Code | 多模态模型，面向编程场景优化 | √ 图片输入   √ 推理模型 |
| Kimi-K2.6 | 多模态模型，适合日常任务 | √ 图片输入   √ 推理模型 |
| Deepseek-V4-Flash | DeepSeek 旗舰模型，支持 1M 上下文窗口，速度优先 | √ 思考模式 |
| Deepseek-V4-Pro | DeepSeek 旗舰模型，支持 1M 上下文窗口 | √ 思考模式 |
...
![](/docs/static/model-1.BuUbNA6x.png)
...
![](/docs/static/model-2.CVISTIZP.png)
...
![](/docs/static/model-3.BzdIKrh6.png)
...
![](/docs/static/model-6.B5r0YXGP.png)

#### 自定义

如果你的模型服务不在上方列表中，可选择**自定义/Custom**，手动填写 URL、API Key 与模型名接入。

![](/docs/static/model-7.Buzcl1Ob.png)
