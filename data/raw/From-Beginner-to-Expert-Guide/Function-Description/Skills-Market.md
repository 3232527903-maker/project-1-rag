<!--
source: https://www.workbuddy.cn/docs/workbuddy/From-Beginner-to-Expert-Guide/Function-Description/Skills-Market
title: 技能​
-->
...
![](/docs/static/skill-1.BLRwED0h.png)
...
![](/docs/static/skill-2.DIhokP9-.png)

* 上传技能：导入本地技能包安装。选择**上传技能**，拖拽或点击 **选择文件**，选中本地技能包即可完成导入。

![](/docs/static/image-17-1.CL2d5GKX.png)

导入后系统将自动完成配置，无需额外操作。

* 查找技能：选择**查找技能**，输入任务描述，WorkBuddy将自动查找相关技能。

![](/docs/static/skill-3.PTyavE2s.png)

* 创建技能：选择**创建技能**，输入任务描述，WorkBuddy将自动创建相关技能。

![](/docs/static/skill-4.Ce9uwHkT.png)

### 启用 / 关闭技能

已安装技能支持随时关闭或重新启用，无需卸载。关闭后该技能不会在对话中被调用。

![](/docs/static/skill-5.DXH8Vvpw.png)
...
![](/docs/static/skill-6.DUKl69US.png)

### 卸载技能

需要在本机完全卸载技能时，可选择**卸载技能**：

![](/docs/static/skilluninstall-20.Decy0AWJ.png)

支持批量操作卸载：

![](/docs/static/skilluninstall-21.BwJOjhUv.png)![](/docs/static/skilluninstall-22.CqbPcSmz.png)
